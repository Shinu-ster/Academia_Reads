...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT stu_id as id, NULL as is_admin,name FROM student WHERE username = '$user' AND password = '$pass' 
        UNION SELECT id, is_admin,name FROM user WHERE username = '$user' AND password = '$pass'";
